...
debug_rsu = 0                   #print information of the rsu commands executed 
debug_obu = 0                   #print information of the obu commands executed 
...
# print sys data
debug_sys = 1                   #print SO-related information
...
#------------------------------------------------------------------------------------------
time_interval = 0.2       #wait time between consecutive movements updates
