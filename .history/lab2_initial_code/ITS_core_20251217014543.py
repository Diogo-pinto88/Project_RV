...
def main(argv):
	...
	try:
		...
		if (node_type==maps.obu_node):
			...
			#               driver_txd_queue: 
			t=Thread(target=obu_system, args=(node_interface, start_flag, coordinates, my_system_rxd_queue, driver_txd_queue,))
			t.start()
			threads.append(t)
		...
		##################################################
			...
			t = Thread(target=driver, args=(node_interface, start_flag, coordinates, driver_txd_queue, ))
			t.start()
			threads.append(t)
			...
			t=Thread(target=movement_control, args=(node_interface, start_flag, coordinates,  driver_txd_queue,))
			t.start()
			threads.append(t)
